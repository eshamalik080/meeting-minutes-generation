...
export default function Login() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      setError(err instanceof ApiError ? err.message : "Couldn't log in. Is the backend running?");
    } finally {
    ...
    <div className="mx-auto max-w-sm px-6 py-20">
      <div className="animate-fade-in rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        <div className="text-center">
          ...
          <h1 className="mt-4 text-xl font-semibold tracking-tight text-slate-900">Log in</h1>
